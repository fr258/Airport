...
<title>List Revenue Generated (Customer)</title>
</head>
<body>
		<% try {
			...
			//Get the selected customer username
			String entity = request.getParameter("flight");
			//Make a SELECT query from the table
			String str = "SELECT SUM(totalFare) totalRevenue, COUNT(*) numTickets FROM ticket t, userInfo u WHERE u.username = t.username AND u.username = '" + entity + "'";
